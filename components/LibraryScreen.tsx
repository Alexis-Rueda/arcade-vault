...
import type { Game, GameCategory } from "@/app/data/types";

export function LibraryScreen({ games, cats }: { games: ReadonlyArray<Game>; cats: ReadonlyArray<"TODOS" | GameCategory> }) {
